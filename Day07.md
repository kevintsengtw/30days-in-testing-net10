...
- [本日學習目標](#本日學習目標)
- [為什麼需要測試替身？](#為什麼需要測試替身)
- [為什麼多數開發者無法跨越單元測試這道門檻？](#為什麼多數開發者無法跨越單元測試這道門檻)
- [相依替換工具介紹](#相依替換工具介紹)
- [Test Double 類型解析](#test-double-類型解析)
- [實戰案例：檔案備份服務重構](#實戰案例檔案備份服務重構)
- [NSubstitute 實戰應用](#nsubstitute-實戰應用)
- [NSubstitute 核心功能詳解](#nsubstitute-核心功能詳解)
- [完整測試案例](#完整測試案例)
- [組裝驗證：composition smoke test](#組裝驗證composition-smoke-test)
- [執行測試](#執行測試)
- [常見陷阱與最佳實務](#常見陷阱與最佳實務)
- [Mock vs Stub 的實戰差異](#mock-vs-stub-的實戰差異)
- [設計品質指標](#設計品質指標)
- [實務建議與進階技巧](#實務建議與進階技巧)
- [本日小結](#本日小結)
- [明日預告](#明日預告)
